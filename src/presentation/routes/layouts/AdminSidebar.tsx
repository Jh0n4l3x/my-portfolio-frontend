...
export function AdminSidebar() {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        { name: 'Todos', path: '/home/projects', icon: <FolderOpen size={18} /> },
        { name: 'Publicados', path: '/home/projects?filter=published', icon: <FolderOpen size={18} /> },
        { name: 'Borradores', path: '/home/projects?filter=draft', icon: <FolderEdit size={18} /> },
        { name: 'Archivados', path: '/home/projects?filter=archived', icon: <Archive size={18} /> },
        { name: 'Nuevo Proyecto', path: '/home/projects/new', icon: <PlusCircle size={18} /> },
      ],
    },
    {
      name: 'Blog',
      ...
      children: [
        { name: 'Posts', path: '/home/blog', icon: <FileText size={18} /> },
        { name: 'Tags', path: '/home/tags', icon: <Tag size={18} /> },
        { name: 'Nuevo Post', path: '/home/blog/new', icon: <PlusCircle size={18} /> },
      ],
    },
    {
      name: 'Mi Perfil',
  ...
  const isActive = (path: string) => {
    ...
    if (targetPath === `/home/${user?.username}`) {
